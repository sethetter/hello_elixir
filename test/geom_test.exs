defmodule GeomTest do
  ...
  test "raises error on negative numbers" do
    assert_raise FunctionClauseError, fn() ->
      Geom.area(:rectangle, -1, 5) == 0
    end
    assert_raise FunctionClauseError, fn() ->
      Geom.area(:rectangle, 1, -5) == 0
    end
    assert_raise FunctionClauseError, fn() ->
      Geom.area(:triangle, -1, 5) == 0
    end
    assert_raise FunctionClauseError, fn() ->
      Geom.area(:triangle, 1, -5) == 0
    end
    assert_raise FunctionClauseError, fn() ->
      Geom.area(:ellipse, -1, 5) == 0
    end
    assert_raise FunctionClauseError, fn() ->
      Geom.area(:ellipse, 1, -5) == 0
    end
  ...
  test "responds to invalid shape with 0" do
